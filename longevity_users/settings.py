"""
Django settings for longevity_users project.
...
MIDDLEWARE = [
    ...
    'users.middleware.CognitoAuthMiddleware',
]
...
COGNITO_CONFIG = {
    ...
    "aws_user_pools_web_client_id": os.getenv("AWS_APP_CLIENT_ID"),
}

ROOT_URLCONF = 'longevity_users.urls'
...
WSGI_APPLICATION = 'longevity_users.wsgi.application'
